...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002160289876')
...
HOW_TO_DOWNLOAD =  environ.get('HOW_TO_DOWNLOAD', 'https://t.me/hd_movies_and_webseries_channel/16')
...
SHORTNER_API =  environ.get('SHORTNER_API', 'd8HZsNDpMeNfnLTdseDQ9IHkrTr2')
